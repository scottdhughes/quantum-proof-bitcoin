...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PQBTC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and payment URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PQBTC addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message…"), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PQBTC addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible PQBTC command-line options").arg(CLIENT_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to PQBTC network.", "", count);
    } else {
        //: A substring of the tooltip.
