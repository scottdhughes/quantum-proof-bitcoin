...
int main(int argc, char** argv)
{
    ...
    if (HelpRequested(argsman)) {
        std::cout << "Usage:  bench_pqbtc [options]\n"
                     "\n"
                  << argsman.GetHelpMessage()
                  << "Description:\n"
                     "\n"
                     "  bench_pqbtc executes microbenchmarks. The quality of the benchmark results\n"
                     ...
                     "\n"
                     "  * bench_pqbtc uses nanobench [3] for which there is extensive\n"
                     ...
                     "\n"
                     "    NANOBENCH_ENDLESS=MuHash ./bench_pqbtc -filter=MuHash\n"
                     "\n"
                     ...
                     "\n"
                     "    NANOBENCH_SUPPRESS_WARNINGS=1 ./bench_pqbtc\n"
                     "\n"
                     "Notes:\n"
                     "\n"
                     "  1. pyperf\n"
